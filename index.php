 ...
 if($s_username == $username && $s_password == $password){
         ...
         $invoice_number="CA-".invoice_number();
 	       header("location:home.php?invoice_number=$invoice_number");
 	  	    ...
 	  	    $error_msg = "<center><font color='red'>Invalid Credential</font></center>";
 }
...
<div class="background">
  <img src="./images/gettyimages-691716142-612x612.jpg">
<center>
		<h1>Pharmacy Management System for Transmara West Sub-County Hospital</h1>
    </center>
	...
	<div class="content" style="width: 400px">
      ...
      <input type="hidden" aucomplete="off" name="invoice_number" value="<?php echo 'CA-'.invoice_number()?>">
		...
		<input type="submit" id="subbtn" name="submit" class="btn btn-success btn-large" value="Login">
